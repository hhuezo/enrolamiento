...
@Component({
  selector: 'app-photography2',
  templateUrl: './photography2.component.html',
  styleUrls: ['./photography2.component.css']
})
export class Photography2Component implements OnInit {
  seconds: number | any;
  ...
  //private url_tmp_upload_file: string = `${environment.HOST}/api/upload_file`;
